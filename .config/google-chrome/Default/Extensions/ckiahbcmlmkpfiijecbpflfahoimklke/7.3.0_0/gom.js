...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
var TAB_ID_DIC, base, constants, en_messages, gom, iced, initBindings, initExtension, keys, main, onAddonReceived, onBeforeSendHeaders, onExternalMessage, onTabUpdated, pages, proxy_activation_errors, proxy_states, reloadTab, tick, __iced_k, __iced_k_noop,
  __slice = [].slice;
...
gom = {
  ...
  onBrowserActionClicked: function() {
    var currentProxyState, ___iced_passed_deferral, __iced_deferrals, __iced_k;
    __iced_k = __iced_k_noop;
    ___iced_passed_deferral = iced.findDeferral(arguments);
    (function(_this) {
      return (function(__iced_k) {
        __iced_deferrals = new iced.Deferrals(__iced_k, {
          parent: ___iced_passed_deferral,
          filename: "/Users/nubela/Workspace/gom-chrome/src/gom.coffee"
        });
        base.getLocalData(keys.PROXY_STATE, null, __iced_deferrals.defer({
          assign_fn: (function() {
            return function() {
              return currentProxyState = arguments[0];
            };
          })(),
          lineno: 15
        }));
      ...
      return function() {
        if (currentProxyState === proxy_states.ACTIVE) {
          base.toggleSpdyProxyActivation(false);
          return;
        }
        return base.toggleSpdyProxyActivation(true, function(success, error) {
          var buttonPressCount, cumUsage, ___iced_passed_deferral1, __iced_deferrals, __iced_k;
          __iced_k = __iced_k_noop;
          ___iced_passed_deferral1 = iced.findDeferral(arguments);
          if (error == null) {
            base.showActivationNotification();
            (function(_this) {
              return (function(__iced_k) {
                __iced_deferrals = new iced.Deferrals(__iced_k, {
                  parent: ___iced_passed_deferral1,
                ...
                base.getLocalData(keys.GOM_BUTTON_PRESS_COUNT, 0, __iced_deferrals.defer({
                  assign_fn: (function() {
                    return function() {
                      return buttonPressCount = arguments[0];
                    };
                  })(),
                  lineno: 23
                }));
              ...
              return function() {
                base.setLocalData(keys.GOM_BUTTON_PRESS_COUNT, buttonPressCount + 1);
                (function(__iced_k) {
                  __iced_deferrals = new iced.Deferrals(__iced_k, {
                    parent: ___iced_passed_deferral1,
                    filename: "/Users/nubela/Workspace/gom-chrome/src/gom.coffee"
                  });
                  base.getLocalData(keys.ACTIVATION_USAGE, constants.DEFAULT_CUMULATIVE_USAGE, __iced_deferrals.defer({
                    assign_fn: (function() {
                      return function() {
                        return cumUsage = arguments[0];
                      };
                  ...
                  cumUsage.lastTick = base.now();
                  (function(__iced_k) {
                    __iced_deferrals = new iced.Deferrals(__iced_k, {
                      parent: ___iced_passed_deferral1,
                      filename: "/Users/nubela/Workspace/gom-chrome/src/gom.coffee"
                    });
                    base.setLocalData(keys.ACTIVATION_USAGE, cumUsage);
                    __iced_deferrals._fulfill();
                  })(__iced_k);
                });
              };
            ...
            return __iced_k(error === proxy_activation_errors.CONFLICTING_EXTENSION ? base.showExtensionConflictNotification() : base.showServerErrorNotification());
          }
        });
      };
    })(this));
...
tick = function() {
  var cumUsage, freeTierMins, isLogined, isPaymentNeeded, lastNagTimestamp, proxyState, ___iced_passed_deferral, __iced_deferrals, __iced_k;
  __iced_k = __iced_k_noop;
  ___iced_passed_deferral = iced.findDeferral(arguments);
  (function(_this) {
    return (function(__iced_k) {
    ...
    return function() {
      (function(__iced_k) {
        ...
        (function(__iced_k) {
          ...
          base.getLocalData(keys.LAST_FREE_PLAN_NAG_TIMESTAMP, 0, __iced_deferrals.defer({
            assign_fn: (function() {
              return function() {
                return lastNagTimestamp = arguments[0];
              };
            })(),
            lineno: 40
          }));
          ...
          (function(__iced_k) {
            ...
            (function(__iced_k) {
              ...
              (function(__iced_k) {
                ...
                if (proxyState === proxy_states.ACTIVE && (isPaymentNeeded || !isLogined)) {
                  if ((freeTierMins * 60 - cumUsage.seconds) < 300 && base.now() - lastNagTimestamp > 300) {
                    base.setLocalData(keys.LAST_FREE_PLAN_NAG_TIMESTAMP, base.now());
                    if (!isLogined) {
                      base.showSignInNagNotification();
                    } else {
                      base.showGoProNagNotification();
                    }
                  }
                }
                if (proxyState === proxy_states.ACTIVE && (isPaymentNeeded || !isLogined)) {
                  cumUsage.seconds = cumUsage.seconds + base.now() - cumUsage.lastTick;
                  cumUsage.lastTick = base.now();
                  base.setLocalData(keys.ACTIVATION_USAGE, cumUsage);
                  base.log(freeTierMins * 60 - cumUsage.seconds);
                  if (cumUsage.seconds >= freeTierMins * 60) {
                    base.toggleSpdyProxyActivation(false);
                    return base.showFreeTierDeactivationNotification();
                  }
                }
              });
            });
...
reloadTab = function(tabId, url) {
  ...
  return chrome.tabs.executeScript(tabId, {
    ...
    url = url != null ? url : TAB_ID_DIC[tabId];
    return chrome.tabs.sendMessage(tabId, {
      method: "stop"
    }, function() {
      return chrome.tabs.sendMessage(tabId, {
        ...
        return delete TAB_ID_DIC[tabId];
      });
    });
  });
};
...
onBeforeSendHeaders = function(details) {
  var header, injected, _i, _len, _ref;
  injected = false;
  _ref = details.requestHeaders;
  for (_i = 0, _len = _ref.length; _i < _len; _i++) {
    header = _ref[_i];
    if (header['name'] === 'Host') {
      header['value'] = 'gom-reflector.appspot.com';
      injected = true;
    }
  }
  if (!injected) {
    details.requestHeaders.push({
      name: 'Host',
      value: 'gom-reflector.appspot.com'
    });
  }
  console.log("meh");
  return {
...
onTabUpdated = function(tabId, changeInfo, tab) {
  var isTabBlocked, proxyState, successfullyInjected, unstrippedUrl, ___iced_passed_deferral, __iced_deferrals, __iced_k;
  __iced_k = __iced_k_noop;
  ___iced_passed_deferral = iced.findDeferral(arguments);

  /*  injects a content script to check if a page is blocked by mda */
  if (changeInfo.status === "complete") {
    (function(_this) {
      return (function(__iced_k) {
        ...
        base.injectContentScript(tabId, __iced_deferrals.defer({
          assign_fn: (function() {
            return function() {
              return successfullyInjected = arguments[0];
            };
          })(),
          lineno: 94
        }));
      ...
      return function() {
        ...
        (function(__iced_k) {
          ...
          base.isTabBlocked(tabId, __iced_deferrals.defer({
            assign_fn: (function() {
              return function() {
                return isTabBlocked = arguments[0];
              };
            })(),
            lineno: 99
          }));
          ...
          (function(__iced_k) {
            ...
            (function(__iced_k) {
              if (isTabBlocked && proxyState !== proxy_states.ACTIVE) {
                (function(__iced_k) {
                  __iced_deferrals = new iced.Deferrals(__iced_k, {
                    parent: ___iced_passed_deferral,
                    filename: "/Users/nubela/Workspace/gom-chrome/src/gom.coffee"
                  });
                  base.toggleSpdyProxyActivation(true, __iced_deferrals.defer({
                    lineno: 102
                  }));
                  __iced_deferrals._fulfill();
                })(function() {
                  base.showActivationNotification();
                  return __iced_k(tabId in TAB_ID_DIC ? (unstrippedUrl = TAB_ID_DIC[tabId], reloadTab(tabId, unstrippedUrl)) : void 0);
                });
              } else {
                return __iced_k();
              }
...
onExternalMessage = function(req, sender, sendResp) {

  /* */
  if ((req != null) && (req.message != null) && req.message === "are_you_installed") {
    sendResp({
      response: true
    });
    return;
...
onAddonReceived = function(addonJsonStr) {
  var addon, addonId, addonName, entity, isInstalled, isPaymentNeeded, ___iced_passed_deferral, __iced_deferrals, __iced_k;
  __iced_k = __iced_k_noop;
  ___iced_passed_deferral = iced.findDeferral(arguments);
  addon = JSON.parse(addonJsonStr);
  addonId = addon["id"];
  addonName = addon["title"];
  entity = addon["bypass_entity"];
  (function(_this) {
    return (function(__iced_k) {
      __iced_deferrals = new iced.Deferrals(__iced_k, {
        parent: ___iced_passed_deferral,
      ...
      base.isAddonIdInstalled(addonId, __iced_deferrals.defer({
        assign_fn: (function() {
          return function() {
            return isInstalled = arguments[0];
          };
        })(),
        lineno: 122
      }));
    ...
    return function() {
      if (isInstalled) {
        base.showRichNotification("" + addonName + " is already installed", "", [
          {
            title: en_messages.VIEW_ADDONS,
            next: function() {
      ...
      base.addAddonToInstallList(addon);
      (function(__iced_k) {
        __iced_deferrals = new iced.Deferrals(__iced_k, {
          parent: ___iced_passed_deferral,
          filename: "/Users/nubela/Workspace/gom-chrome/src/gom.coffee"
        ...
        if (isPaymentNeeded) {
          base.showRichNotification("" + addonName + " successfully installed, but will not be activated until you upgrade to Pro", "Upgrade to Pro to enable addons", [
            {
              title: en_messages.VIEW_ADDONS,
              next: function() {
                return base.openPage(pages.OPTIONS);
              ...
              next: function() {
                return base.openPage(pages.PRICING);
              }
            }
          ]);
          return;
        }
        base.showRichNotification("" + addonName + " successfully installed!", "Gom will now automatically activate to bypass " + entity, [
          {
            title: en_messages.VIEW_ADDONS,
            next: function() {
              return base.openPage(pages.OPTIONS);
...
initBindings = function() {
  ...
  return chrome.runtime.onMessage.addListener(onAddonReceived);
};

initExtension = function() {
  var deviceId, reloadCount, ___iced_passed_deferral, __iced_deferrals, __iced_k;
  __iced_k = __iced_k_noop;
  ___iced_passed_deferral = iced.findDeferral(arguments);

  /* Initiatlizes the following if not already done so
  - ping working api hosts
  - device_id
   */
  base.pingAllApiHosts();
  (function(_this) {
    return (function(__iced_k) {
      __iced_deferrals = new iced.Deferrals(__iced_k, {
        parent: ___iced_passed_deferral,
    ...
    return function() {
      if (typeof deviceId === "undefined" || deviceId === null) {
        deviceId = base.genUuid();
        base.setLocalData(keys.DEVICE_ID, deviceId);
        base.openPage(pages.HOW_TO_USE, true);
      }
      (function(__iced_k) {
        __iced_deferrals = new iced.Deferrals(__iced_k, {
          parent: ___iced_passed_deferral,
        ...
        base.getLocalData(keys.RELOAD_COUNT, 0, __iced_deferrals.defer({
          assign_fn: (function() {
            return function() {
              return reloadCount = arguments[0];
            };
          })(),
          lineno: 187
        }));
        ...
        base.setLocalData(keys.RELOAD_COUNT, reloadCount + 1);
        return base.touch(deviceId);
      });
    };
  })(this));
};
...
module.exports = window.gom;

}).call(this,require("pBGvAp"),typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {},require("buffer").Buffer,arguments[3],arguments[4],arguments[5],arguments[6],"/fake_9e107dc2.js","/")
},{"./base":5,"./constants":7,"./enum/keys":9,"./enum/pages":10,"./enum/proxy_activation_errors":11,"./enum/proxy_states":13,"./messages/en":15,"buffer":2,"pBGvAp":4}],15:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
var messages;
