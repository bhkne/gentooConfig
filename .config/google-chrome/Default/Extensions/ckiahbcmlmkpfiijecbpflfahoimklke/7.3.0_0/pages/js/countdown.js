...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
var base, constants, iced, initView, keys, pages, proxy_loading_states, proxy_states, tick, __iced_k, __iced_k_noop,
  __slice = [].slice;
...
tick = function() {
  var cumUsage, humnizedDuration, momentDuration, rechargeMins, secDurationMore, seconds, secsThatMustBeElapsed, ___iced_passed_deferral, __iced_deferrals, __iced_k;
  __iced_k = __iced_k_noop;
  ___iced_passed_deferral = iced.findDeferral(arguments);
  (function(_this) {
    return (function(__iced_k) {
      __iced_deferrals = new iced.Deferrals(__iced_k, {
        parent: ___iced_passed_deferral,
        filename: "/Users/nubela/Workspace/gom-chrome/src/pages/js/countdown.coffee"
      });
    ...
    return function() {
      (function(__iced_k) {
        ...
        secsThatMustBeElapsed = rechargeMins * 60;
        if (cumUsage.waitedSeconds >= secsThatMustBeElapsed) {
          base.setLocalData(keys.ACTIVATION_USAGE, constants.DEFAULT_CUMULATIVE_USAGE);
          base.redirect(pages.POPUP.ACTIVATION);
          return;
        }
        secDurationMore = secsThatMustBeElapsed - cumUsage.waitedSeconds;
        humnizedDuration = moment.duration(secDurationMore, 'seconds').humanize();
        momentDuration = moment.duration(secDurationMore, 'seconds');
        seconds = momentDuration.seconds() >= 10 ? momentDuration.seconds() : "0" + (momentDuration.seconds());
        $('.countdown-timer').text("" + (momentDuration.minutes()) + ":" + seconds + " more");
        cumUsage.waitedSeconds += 1;
        return base.setLocalData(keys.ACTIVATION_USAGE, cumUsage);
      });
    };
  })(this));
};
...
initView = function() {
  var isLogined, isPaymentNeeded, ___iced_passed_deferral, __iced_deferrals, __iced_k;
  __iced_k = __iced_k_noop;
  ___iced_passed_deferral = iced.findDeferral(arguments);
  (function(_this) {
    return (function(__iced_k) {
    ...
    return function() {
      (function(__iced_k) {
        ...
        return $("#go-pro-btn").on("click", function() {
          return base.openPage(pages.PRICING, true);
        });
      });
    };
...
}).call(this,require("pBGvAp"),typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {},require("buffer").Buffer,arguments[3],arguments[4],arguments[5],arguments[6],"/fake_a9da97d3.js","/")
},{"./base":5,"./constants":7,"./enum/keys":9,"./enum/pages":10,"./enum/proxy_loading_states":12,"./enum/proxy_states":13,"buffer":2,"pBGvAp":4}],15:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
var messages;
