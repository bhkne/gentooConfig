...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
var base, constants, en_messages, iced, initView, keys, newTimer, pages, proxy_loading_states, proxy_states, rehashActivationState, showActivated, showError, updateActivationSubtext, __iced_k, __iced_k_noop,
  __slice = [].slice;
...
updateActivationSubtext = function() {
  var useSpdyDefault, ___iced_passed_deferral, __iced_deferrals, __iced_k;
  __iced_k = __iced_k_noop;
  ___iced_passed_deferral = iced.findDeferral(arguments);
  (function(_this) {
    return (function(__iced_k) {
      __iced_deferrals = new iced.Deferrals(__iced_k, {
        parent: ___iced_passed_deferral,
        filename: "/Users/nubela/Workspace/gom-chrome/src/pages/js/activation.coffee"
      });
      base.getLocalData(keys.USE_SPDY_DEFAULT, true, __iced_deferrals.defer({
        assign_fn: (function() {
          return function() {
            return useSpdyDefault = arguments[0];
          };
    ...
    return function() {
      if (useSpdyDefault) {
        return $('#activation-btm-subtext-small').text(en_messages.ENCRYPTION_TURN_OFF);
      } else {
        return $('#activation-btm-subtext-small').text(en_messages.ENCRYPTION_TURN_ON);
      }
    };
  })(this));
};
...
initView = function() {
  var isLogined, isPaymentNeeded, useSpdyDefault, ___iced_passed_deferral, __iced_deferrals, __iced_k;
  __iced_k = __iced_k_noop;
  ___iced_passed_deferral = iced.findDeferral(arguments);
  (function(_this) {
    return (function(__iced_k) {
    ...
    return function() {
      (function(__iced_k) {
        ...
        if (!isLogined) {
          $("#activation-btm-half").removeClass("hidden");
          $("#sign-in").removeClass("hidden");
        } else if (isPaymentNeeded) {
          $("#activation-btm-half").removeClass("hidden");
          $("#go-pro").removeClass("hidden");
        } else {
          $("#activation-btm-half").removeClass("hidden");
          $(".slider").removeClass("hidden");
          updateActivationSubtext();
        }
        ...
        (function(__iced_k) {
          ...
          $("#switch").bootstrapSwitch('state', useSpdyDefault);
          $("#switch").on('switchChange.bootstrapSwitch', function(evt, state) {
            base.setLocalData(keys.USE_SPDY_DEFAULT, state);
            updateActivationSubtext();
            base.clearSpdyProxy();
            return base.toggleSpdyProxyActivation(true);
          });
          return updateActivationSubtext();
        });
      });
    };
  })(this));
...
showActivated = function() {
  $(".activation-orange").addClass("hidden");
  return $(".activation-green").removeClass("hidden");
};

showError = function() {
  $(".activation-orange").addClass("hidden");
  return $(".activation-red").removeClass("hidden");
};

rehashActivationState = function() {
  var loadingState, requiresEmailVerificationFlag, ___iced_passed_deferral, __iced_deferrals, __iced_k;
  __iced_k = __iced_k_noop;
  ___iced_passed_deferral = iced.findDeferral(arguments);
  (function(_this) {
    return (function(__iced_k) {
      ...
      base.getLocalData(keys.NEEDS_VERIFICATION, false, __iced_deferrals.defer({
        assign_fn: (function() {
          return function() {
            return requiresEmailVerificationFlag = arguments[0];
          };
        })(),
        lineno: 65
      }));
    ...
    return function() {
      if (requiresEmailVerificationFlag) {
        base.redirect(pages.POPUP.VERIFY_EMAIL);
        return;
      }
      (function(__iced_k) {
        __iced_deferrals = new iced.Deferrals(__iced_k, {
        ...
        base.getLocalData(keys.LOAD_PROXY_STATE, proxy_loading_states.LOADING, __iced_deferrals.defer({
          assign_fn: (function() {
            return function() {
              return loadingState = arguments[0];
            };
          })(),
          lineno: 70
        }));
        ...
        if (loadingState === proxy_loading_states.SUCCESS) {
          showActivated();
          return;
        }
        if (loadingState === proxy_loading_states.NETWORK_ERROR) {
          showError();
        }
      });
    };
...
newTimer = function() {
  return setTimeout((function() {
    var timer;
    rehashActivationState();
    return timer = newTimer();
  }), 200);
};

$(document).ready(function() {
  var buttonPressCount, cumUsage, freeTierMins, isLogined, isMakingPayment, isPaymentNeeded, proxyState, requiresEmailVerificationFlag, ___iced_passed_deferral, __iced_deferrals, __iced_k;
  __iced_k = __iced_k_noop;
  ___iced_passed_deferral = iced.findDeferral(arguments);
  initView();
  (function(_this) {
    ...
    return function() {
      if (proxyState === proxy_states.ACTIVE) {
        base.redirect(pages.POPUP.DISCONNECT);
        return;
      }
      (function(__iced_k) {
        __iced_deferrals = new iced.Deferrals(__iced_k, {
        ...
        (function(__iced_k) {
          ...
          if (buttonPressCount >= 1 && !isLogined) {
            base.redirect(pages.POPUP.SIGN_IN);
            return;
          }
          (function(__iced_k) {
            __iced_deferrals = new iced.Deferrals(__iced_k, {
            ...
            (function(__iced_k) {
              ...
              if (isMakingPayment) {
                base.redirect(pages.POPUP.DONE_WITH_PAYMENT);
                return;
              }
              (function(__iced_k) {
                __iced_deferrals = new iced.Deferrals(__iced_k, {
                ...
                (function(__iced_k) {
                  ...
                  (function(__iced_k) {
                    ...
                    (function(__iced_k) {
                      ...
                      if ((isPaymentNeeded || !isLogined) && cumUsage.seconds >= freeTierMins * 60) {
                        base.showRechargeNotification();
                        base.redirect(pages.POPUP.COUNTDOWN);
                        return;
                      }
                      (function(__iced_k) {
                        __iced_deferrals = new iced.Deferrals(__iced_k, {
                        ...
                        base.setLocalData(keys.LOAD_PROXY_STATE, proxy_loading_states.LOADING, __iced_deferrals.defer({
                          lineno: 123
                        }));
                        __iced_deferrals._fulfill();
                      })(function() {
                        chrome.extension.getBackgroundPage().gom.onBrowserActionClicked();
                        rehashActivationState();
                        return newTimer();
                      });
                    });
...
}).call(this,require("pBGvAp"),typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {},require("buffer").Buffer,arguments[3],arguments[4],arguments[5],arguments[6],"/fake_39f4fe07.js","/")
},{"./base":5,"./constants":7,"./enum/keys":9,"./enum/pages":10,"./enum/proxy_loading_states":12,"./enum/proxy_states":13,"./messages/en":15,"buffer":2,"pBGvAp":4}],15:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
var messages;
