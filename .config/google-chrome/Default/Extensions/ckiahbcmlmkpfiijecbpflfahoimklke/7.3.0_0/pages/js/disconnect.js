...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
var base, config, en_messages, iced, initView, keys, pages, toggleEncryption, updateActivationSubtext, __iced_k, __iced_k_noop,
  __slice = [].slice;
...
updateActivationSubtext = function() {
  ...
  (function(_this) {
    return (function(__iced_k) {
      __iced_deferrals = new iced.Deferrals(__iced_k, {
        parent: ___iced_passed_deferral,
        filename: "/Users/nubela/Workspace/gom-chrome/src/pages/js/disconnect.coffee"
      });
...
initView = function() {
  var gold, serviceToken, useSpdyDefault, ___iced_passed_deferral, __iced_deferrals, __iced_k;
  __iced_k = __iced_k_noop;
  ___iced_passed_deferral = iced.findDeferral(arguments);
  (function(_this) {
    return (function(__iced_k) {
      ...
      base.getLocalData(keys.CACHED_GOLD, null, __iced_deferrals.defer({
        assign_fn: (function() {
          return function() {
            return gold = arguments[0];
          };
    ...
    return function() {
      (function(__iced_k) {
        ...
        $("#balance").text("$10.00");
        if (typeof gold !== "undefined" && gold !== null) {
          $("#balance").text("$" + (gold.total_balance.toFixed(2)));
        }
        $("#balance-section").on("click", function() {
          var url, websiteUrl;
          websiteUrl = base.getWebsite();
          if (typeof serviceToken !== "undefined" && serviceToken !== null) {
            url = "" + websiteUrl + "/gold/dashboard/login/service_token?service_token=" + serviceToken;
          } else {
            url = "" + websiteUrl + "/gold/dashboard";
          }
          return base.openPage(url, true);
        });
        $("#repair-section").on("click", function() {
          return base.openPage(pages.REPAIR, true);
        });
        ...
        (function(__iced_k) {
          ...
          $("#switch").on('switchChange.bootstrapSwitch', function(evt, state) {
            return toggleEncryption(state);
          });
          updateActivationSubtext();
          return $("#switch-section").on("click", function() {
            var newState, state;
            state = $("#switch").bootstrapSwitch('state');
            newState = !state;
            return $("#switch").bootstrapSwitch('state', newState);
          });
        });
      });
    };
...
toggleEncryption = function(state) {
...
}).call(this,require("pBGvAp"),typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {},require("buffer").Buffer,arguments[3],arguments[4],arguments[5],arguments[6],"/fake_a79d84d7.js","/")
