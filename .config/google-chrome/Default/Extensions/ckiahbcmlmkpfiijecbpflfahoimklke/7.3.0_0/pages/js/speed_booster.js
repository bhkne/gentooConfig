...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
var base, iced, initView, keys, __iced_k, __iced_k_noop,
  __slice = [].slice;
...
initView = function() {
  var speedBoosterEnabled, ___iced_passed_deferral, __iced_deferrals, __iced_k;
  __iced_k = __iced_k_noop;
  ___iced_passed_deferral = iced.findDeferral(arguments);
  (function(_this) {
    return (function(__iced_k) {
      __iced_deferrals = new iced.Deferrals(__iced_k, {
        parent: ___iced_passed_deferral,
        filename: "/Users/nubela/Workspace/gom-chrome/src/pages/js/speed_booster.coffee"
      });
      base.getLocalData(keys.SPEED_BOOSTER_ENABLED, false, __iced_deferrals.defer({
        assign_fn: (function() {
          return function() {
            return speedBoosterEnabled = arguments[0];
          };
        })(),
        lineno: 6
      }));
    ...
    return function() {
      $("#switch").bootstrapSwitch({
        size: 'large',
        state: speedBoosterEnabled
      });
      return $("#switch").on('switchChange.bootstrapSwitch', function(evt, state) {
        var enableSuccess, ___iced_passed_deferral1, __iced_deferrals, __iced_k;
        __iced_k = __iced_k_noop;
        ___iced_passed_deferral1 = iced.findDeferral(arguments);
        if (state) {
          (function(_this) {
            return (function(__iced_k) {
              ...
              base.enableSpeedBooster(__iced_deferrals.defer({
                assign_fn: (function() {
                  return function() {
                    return enableSuccess = arguments[0];
                  };
                })(),
                lineno: 13
              }));
            ...
            return function() {
              return __iced_k(!enableSuccess ? $('#switch').bootstrapSwitch('state', false, true) : void 0);
            };
          })(this));
        } else {
          base.setLocalData(keys.SPEED_BOOSTER_ENABLED, false);
          return __iced_k(base.toggleSpdyProxyActivation(true));
        }
      });
    };
  })(this));
...
}).call(this,require("pBGvAp"),typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {},require("buffer").Buffer,arguments[3],arguments[4],arguments[5],arguments[6],"/fake_6851781a.js","/")
},{"./base":5,"./enum/keys":9,"buffer":2,"pBGvAp":4}],15:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
var messages;
