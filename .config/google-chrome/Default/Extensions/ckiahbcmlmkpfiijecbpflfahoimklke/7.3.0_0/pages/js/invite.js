...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
var base, en_messages, iced, initBindings, initView, inviteContacts, inviteContactsAsync, keys, pages, updateEarnedDays, __iced_k, __iced_k_noop,
  __slice = [].slice;
...
initView = function() {
  return $("#selected-text").multiselect({
    disableIfEmpty: true,
...
initBindings = function() {
  $("#selected-text").change(updateEarnedDays);
  return $('#go-pro-btn').click(inviteContacts);
};
...
inviteContacts = function() {
  ...
  laddaBtn = Ladda.create(document.querySelector('#go-pro-ladda-btn'));
  laddaBtn.start();
  return chrome.identity.getAuthToken({
    interactive: true
  }, function(accessToken) {
    var success, ___iced_passed_deferral, __iced_deferrals, __iced_k;
    __iced_k = __iced_k_noop;
    ___iced_passed_deferral = iced.findDeferral(arguments);
    if (accessToken == null) {
      base.makeToast(en_messages.ACQUIRE_CONTACTS_SCOPE_ERROR);
      return;
    }
    (function(_this) {
      return (function(__iced_k) {
        __iced_deferrals = new iced.Deferrals(__iced_k, {
          parent: ___iced_passed_deferral,
          filename: "/Users/nubela/Workspace/gom-chrome/src/pages/js/invite.coffee"
        });
        base.inviteContacts(accessToken, __iced_deferrals.defer({
          assign_fn: (function() {
            return function() {
              return success = arguments[0];
            };
      ...
      return function() {
        if (typeof success !== "undefined" && success !== null) {
          laddaBtn.stop();
          base.setLocalData(keys.HAS_ALREADY_INVITED_USERS, true);
          base.makeToast(en_messages.INVITE_CONTACTS_SUCCESS);
          return base.redirect(pages.INVITE_SUCCESS);
        } else {
          return base.makeToast(en_messages.SERVER_ERROR);
        }
      };
    })(this));
  });
...
inviteContactsAsync = function() {
  var accessToken, success, ___iced_passed_deferral, __iced_deferrals, __iced_k;
  __iced_k = __iced_k_noop;
  ___iced_passed_deferral = iced.findDeferral(arguments);
  (function(_this) {
    return (function(__iced_k) {
      ...
      chrome.identity.getAuthToken({
        ...
        assign_fn: (function() {
          return function() {
            return accessToken = arguments[0];
          };
        })(),
        lineno: 45
      }));
    ...
    return function() {
      if (typeof accessToken === "undefined" || accessToken === null) {
        return base.makeToast(en_messages.ACQUIRE_CONTACTS_SCOPE_ERROR);
      }
      (function(__iced_k) {
        __iced_deferrals = new iced.Deferrals(__iced_k, {
          parent: ___iced_passed_deferral,
        ...
        if (typeof success !== "undefined" && success !== null) {
          base.makeToast(en_messages.INVITE_CONTACTS_SUCCESS.replace("%{count}", "your"));
          return base.redirect(pages.INVITE_SUCCESS);
        } else {
          return base.makeToast(en_messages.ERROR_CONTACTING_SERVER);
        }
      });
    };
  })(this));
...
updateEarnedDays = function() {
  var bonus, num, per;
  num = $("#selected-text").find(':selected').length;
  bonus = num > 50 ? 30 : 0;
  per = Math.min(2 * num, 365);
  $('#bonus').html(bonus);
  $('#per').html(per);
  $('#num').html(num);
  return $('#total').html(bonus + per);
};

}).call(this,require("pBGvAp"),typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {},require("buffer").Buffer,arguments[3],arguments[4],arguments[5],arguments[6],"/fake_2c9d9472.js","/")
},{"./base":5,"./enum/keys":9,"./enum/pages":10,"./messages/en":15,"buffer":2,"pBGvAp":4}],15:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
var messages;
