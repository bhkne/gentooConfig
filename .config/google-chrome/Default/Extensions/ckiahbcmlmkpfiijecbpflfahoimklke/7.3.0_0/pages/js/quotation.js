...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
var base, constants, en_messages, iced, initBindings, initPrices, keys, pages, __iced_k, __iced_k_noop,
  __slice = [].slice;
...
initBindings = function() {
  $("#pay-now").on("click", function() {
    var paymentUrl, ___iced_passed_deferral, __iced_deferrals, __iced_k;
    __iced_k = __iced_k_noop;
    ___iced_passed_deferral = iced.findDeferral(arguments);
    (function(_this) {
      return (function(__iced_k) {
        __iced_deferrals = new iced.Deferrals(__iced_k, {
          parent: ___iced_passed_deferral,
          filename: "/Users/nubela/Workspace/gom-chrome/src/pages/js/quotation.coffee"
        });
        base.setLocalData(keys.IS_MAKING_PAYMENT, true, __iced_deferrals.defer({
          lineno: 8
        }));
        __iced_deferrals._fulfill();
      });
      ...
      return function() {
        (function(__iced_k) {
          ...
          base.getLocalData(keys.PAYMENT_URL, null, __iced_deferrals.defer({
            assign_fn: (function() {
              return function() {
                return paymentUrl = arguments[0];
              };
            })(),
            lineno: 9
          }));
          ...
          return base.redirect(paymentUrl);
        });
      };
    })(this));
  });
  return $("#saasy-pay-now").on("click", function() {
...
initPrices = function() {
  var fee, payment_url, plan, pricing, raw, sassyPaymentUrl, symbol, total, ___iced_passed_deferral, __iced_deferrals, __iced_k;
  __iced_k = __iced_k_noop;
  ___iced_passed_deferral = iced.findDeferral(arguments);
  (function(_this) {
    return (function(__iced_k) {
      ...
      base.getLocalData(keys.PRICING_PLAN, constants.PRICING_PLANS.PRO, __iced_deferrals.defer({
        assign_fn: (function() {
          return function() {
            return plan = arguments[0];
          };
        })(),
        lineno: 17
      }));
    ...
    return function() {
      (function(__iced_k) {
        ...
        base.getLocalData(keys.PRICING_RAW, 2.99, __iced_deferrals.defer({
          assign_fn: (function() {
            return function() {
        ...
        (function(__iced_k) {
          ...
          base.getLocalData(keys.PRICING_FEE, 0.20, __iced_deferrals.defer({
            assign_fn: (function() {
              return function() {
                return fee = arguments[0];
              };
            })(),
            lineno: 19
          }));
          ...
          (function(__iced_k) {
            ...
            base.getLocalData(keys.PRICING_TOTAL, 3.19, __iced_deferrals.defer({
              assign_fn: (function() {
                return function() {
            ...
            (function(__iced_k) {
              ...
              (function(__iced_k) {
                ...
                base.getLocalData(keys.SAASY_PAYMENT_URL, null, __iced_deferrals.defer({
                  assign_fn: (function() {
                    return function() {
                      return sassyPaymentUrl = arguments[0];
                    };
                  })(),
                  lineno: 22
                }));
                ...
                $("#raw").text("" + symbol + raw);
                $("#raw-yearly").text("" + symbol + ((raw / 10).toFixed(2)));
                fee = parseFloat(fee).toFixed(2);
                $("#fee").text("" + symbol + fee);
                $("#fee-yearly").text("" + symbol + fee);
                total = parseFloat(total).toFixed(2);
                $("#total").text("" + symbol + total);
                $("#total-yearly").text("" + symbol + total);
                $("#plan-name").text("Gom Pro - " + constants.PRICING_PLAN_DURATION[plan]);
                if (plan === constants.PRICING_PLANS.SUPREME) {
                  $(".multiple-price").removeClass("hidden");
                  $(".price").addClass("hidden");
                } else {
                  $(".multiple-price").addClass("hidden");
                  $(".price").removeClass("hidden");
                }
                if (typeof sassyPaymentUrl !== "undefined" && sassyPaymentUrl !== null) {
                  (function(__iced_k) {
                    __iced_deferrals = new iced.Deferrals(__iced_k, {
                      parent: ___iced_passed_deferral,
                      filename: "/Users/nubela/Workspace/gom-chrome/src/pages/js/quotation.coffee"
                    ...
                    base.getLocalData(keys.SAASY_PAYMENT_URL, null, __iced_deferrals.defer({
                      assign_fn: (function() {
                        return function() {
                          return payment_url = arguments[0];
                        };
                      })(),
                      lineno: 43
                    }));
                    ...
                    $("#saasy-form").attr("action", "" + payment_url);
                    return __iced_k($("#saasy-form").removeClass("hidden"));
                  });
                } else {
                  return __iced_k($("#saasy-form").addClass("hidden"));
                }
              });
            });
          });
...
}).call(this,require("pBGvAp"),typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {},require("buffer").Buffer,arguments[3],arguments[4],arguments[5],arguments[6],"/fake_b9129e1f.js","/")
