...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
var base, beginSync, capitalize, config, constants, doEmailVerificationCheck, iced, initView, keys, pages, populatePage, __iced_k, __iced_k_noop, _populateInstalledAddons, _populateSuggestedAddons,
  __slice = [].slice;
...
_populateSuggestedAddons = function() {
  var addon, addon_desc, addon_id, addon_name, bypass_entity, cloned_addon, suggestedAddons, ___iced_passed_deferral, __iced_deferrals, __iced_k;
  __iced_k = __iced_k_noop;
  ___iced_passed_deferral = iced.findDeferral(arguments);
  (function(_this) {
    return (function(__iced_k) {
      __iced_deferrals = new iced.Deferrals(__iced_k, {
        parent: ___iced_passed_deferral,
        filename: "/Users/nubela/Workspace/gom-chrome/src/pages/js/options.coffee"
      });
      base.getLocalData(keys.SUGGESTED_ADDONS, constants.DEFAULT_SUGGESTED_ADDONS, __iced_deferrals.defer({
        assign_fn: (function() {
          return function() {
            return suggestedAddons = arguments[0];
          };
        })(),
        lineno: 10
      }));
    ...
    return function() {
      ...
      if (suggestedAddons.length === 0) {
        $("#suggested-addons").addClass("hidden");
        return;
      }
      $("#suggested-addons").removeClass("hidden");
      $("#suggested-addons").find(".installed-addon").remove();
      _results = [];
      for (_i = 0, _len = suggestedAddons.length; _i < _len; _i++) {
        addon = suggestedAddons[_i];
        addon_name = addon["title"];
        bypass_entity = addon["bypass_entity"];
        addon_id = addon["id"];
        addon_desc = "bypasses " + bypass_entity;
        cloned_addon = $("#suggested-addon-template").clone().removeAttr("id").removeClass("hidden");
        $(cloned_addon).find(".add-addon-plus").attr("data-add-addon", JSON.stringify(addon));
        $(cloned_addon).find("h4").text(addon_name);
        $(cloned_addon).find(".addon-desc").text(addon_desc);
        $(cloned_addon).find(".add-addon-plus").on("click", function() {
          var addon_to_add_id, filteredSuggestedADdons, isDone, json_str, thisAddon, ___iced_passed_deferral1, __iced_deferrals, __iced_k;
          __iced_k = __iced_k_noop;
          ___iced_passed_deferral1 = iced.findDeferral(arguments);
          json_str = $(this).attr("data-add-addon");
          thisAddon = JSON.parse(json_str);
          addon_to_add_id = thisAddon["id"];
          filteredSuggestedADdons = (function() {
            var _j, _len1, _results1;
            _results1 = [];
            for (_j = 0, _len1 = suggestedAddons.length; _j < _len1; _j++) {
              addon = suggestedAddons[_j];
              if (addon["id"] !== addon_to_add_id) {
                _results1.push(addon);
              }
            }
            return _results1;
          })();
          (function(_this) {
            return (function(__iced_k) {
              ...
              base.addAddonToInstallList(thisAddon, __iced_deferrals.defer({
                assign_fn: (function() {
                  return function() {
                    return isDone = arguments[0];
                  };
                })(),
                lineno: 34
              }));
            ...
            return function() {
              (function(__iced_k) {
                ...
                base.setLocalData(keys.SUGGESTED_ADDONS, filteredSuggestedADdons, __iced_deferrals.defer({
                  assign_fn: (function() {
                    return function() {
                ...
                _populateSuggestedAddons();
                _populateInstalledAddons();
                return base.reloadSpdyProxy(false);
              });
            };
          })(this));
        });
        _results.push($("#suggested-addons").append(cloned_addon));
      }
      return _results;
    };
  })(this));
...
_populateInstalledAddons = function() {
  var addon, addonDesc, addonId, addonName, bypass_entity, cloneAddon, installedAddons, ___iced_passed_deferral, __iced_deferrals, __iced_k;
  __iced_k = __iced_k_noop;
  ___iced_passed_deferral = iced.findDeferral(arguments);
  (function(_this) {
    return (function(__iced_k) {
    ...
    return function() {
      ...
      if (installedAddons.length === 0) {
        $("#installed-addons").addClass("hidden");
        return;
      }
      $("#installed-addons").removeClass("hidden");
      $("#installed-addons").find(".installed-addon").remove();
      _results = [];
      for (_i = 0, _len = installedAddons.length; _i < _len; _i++) {
        addon = installedAddons[_i];
        ...
        bypass_entity = addon["bypass_entity"];
        addonId = addon["id"];
        addonDesc = "bypasses " + bypass_entity;
        cloneAddon = $("#addon-template").clone().removeAttr("id").removeClass("hidden");
        $(cloneAddon).find(".rm-addon-cross").attr("data-rm-addon-id", addonId);
        $(cloneAddon).find("h4").text(addonName);
        $(cloneAddon).find(".addon-desc").text(addonDesc);
        $(cloneAddon).find(".rm-addon-cross").on("click", function() {
          ...
          (function(_this) {
            return (function(__iced_k) {
              ...
              base.rmAddonToInstallList($(_this).attr("data-rm-addon-id"), __iced_deferrals.defer({
                lineno: 64
              }));
              __iced_deferrals._fulfill();
            });
        ...
        _results.push($("#installed-addons").append(cloneAddon));
      }
      return _results;
    };
  })(this));
...
populatePage = function() {
  var accountInfo, days, diff, email, expiryEpoch, isAccountValid, isGold, isPro, paymentCredit, paymentPlan, plan, planStr, prettyTimeLeft, timestamp_now, ___iced_passed_deferral, __iced_deferrals, __iced_k;
  __iced_k = __iced_k_noop;
  ___iced_passed_deferral = iced.findDeferral(arguments);
  (function(_this) {
    return (function(__iced_k) {
        ...
        (function(__iced_k) {
          ...
          (function(__iced_k) {
            ...
            base.isLogined(__iced_deferrals.defer({
              assign_fn: (function() {
                return function() {
                  return isAccountValid = arguments[0];
                };
              })(),
              lineno: 74
            }));
            ...
            (function(__iced_k) {
              if (!isAccountValid) {
                $("#account-status").removeClass("status-red");
                $("#account-status").removeClass("status-green");
                $("#account-status").addClass("status-red");
                $("#full-account-info").addClass("hidden");
                return __iced_k($("#sign-in-entry").removeClass("hidden"));
              } else {
                $("#full-account-info").removeClass("hidden");
                $("#sign-in-entry").addClass("hidden");
                email = accountInfo.email;
                $("#email-input").text(email);
                expiryEpoch = paymentCredit["credit_expiry_epoch"];
                timestamp_now = new Date().getTime() / 1000;
                diff = parseInt(expiryEpoch) - timestamp_now;
                days = diff / 86400;
                prettyTimeLeft = "" + (moment.duration(diff * 1000).humanize()) + " left";
                if (diff <= 0) {
                ...
                (function(__iced_k) {
                  ...
                  base.isGold(__iced_deferrals.defer({
                    assign_fn: (function() {
                      return function() {
                        return isGold = arguments[0];
                      };
                    })(),
                    lineno: 100
                  }));
                  ...
                  if (isGold) {
                    $("#pri-upgrade-btn").addClass("hidden");
                  }
                  (function(__iced_k) {
                    __iced_deferrals = new iced.Deferrals(__iced_k, {
                      parent: ___iced_passed_deferral,
                    ...
                    base.isPro(__iced_deferrals.defer({
                      assign_fn: (function() {
                        return function() {
                          return isPro = arguments[0];
                        };
                      })(),
                      lineno: 105
                    }));
                    ...
                    if (isGold) {
                      ...
                      plan = "Pro";
                    } else if ("plan" in paymentPlan) {
                      plan = capitalize(paymentPlan["plan"]);
                    }
                    planStr = plan;
                    if (plan.toLowerCase() === "trial") {
                      planStr = "Trial (" + prettyTimeLeft + ")";
                    }
                    $("#plan-input").text("" + planStr);
                    $("#account-status").removeClass("status-red");
                    $("#account-status").removeClass("status-green");
                    return __iced_k(plan.toLowerCase() !== "trial" && diff > 0 ? $("#account-status").addClass("status-green") : $("#account-status").addClass("status-red"));
                  });
                });
              }
            })(function() {
              _populateInstalledAddons();
              return _populateSuggestedAddons();
            });
          });
        });
      });
...
initView = function() {
  ...
  $("#search-addons-form").attr("action", "" + config.GOM_WEBSITE + "/addons");
  $("[data-hide-scrim]").on("click", function() {
    $(".scrim").addClass("hidden");
    $("#checking-payment").addClass("hidden");
    $("#payment-success").addClass("hidden");
    return base.setLocalData(keys.IS_MAKING_PAYMENT, false);
  });
  $(".cross-btn").on("click", function() {
    $(".scrim").addClass("hidden");
    $("#make-payment").addClass("hidden");
    return $("#verify-email").addClass("hidden");
  });
  return $("#resend-verification-btn").on("click", function() {
    var email, laddaBtn, needsEmailVerification, resendSuccess, ___iced_passed_deferral, __iced_deferrals, __iced_k;
    __iced_k = __iced_k_noop;
    ___iced_passed_deferral = iced.findDeferral(arguments);
    if ($(this).attr("disabled") != null) {
      return;
    }
    laddaBtn = Ladda.create(document.querySelector('#resend-verification-ladda-btn'));
    laddaBtn.start();
    (function(_this) {
      return (function(__iced_k) {
        __iced_deferrals = new iced.Deferrals(__iced_k, {
        ...
        beginSync(__iced_deferrals.defer({
          lineno: 155
        }));
        __iced_deferrals._fulfill();
      });
      ...
      return function() {
        (function(__iced_k) {
          ...
          base.getLocalData(keys.NEEDS_VERIFICATION, false, __iced_deferrals.defer({
            assign_fn: (function() {
              return function() {
                return needsEmailVerification = arguments[0];
              };
            })(),
            lineno: 156
          }));
          ...
          (function(__iced_k) {
            ...
            (function(__iced_k) {
              ...
              base.resendVerificationEmail(email, __iced_deferrals.defer({
                assign_fn: (function() {
                  return function() {
                    return resendSuccess = arguments[0];
                  };
                })(),
                lineno: 163
              }));
              ...
              if (resendSuccess) {
                ...
                return $("#resend-verification-ladda-btn").text("EMAIL SENT");
              }
            });
          });
        });
...
beginSync = function(deferredCallback) {
  var pricing, syncSuccess, ___iced_passed_deferral, __iced_deferrals, __iced_k;
  __iced_k = __iced_k_noop;
  ___iced_passed_deferral = iced.findDeferral(arguments);
  if (deferredCallback == null) {
    deferredCallback = (function() {});
  ...
  (function(_this) {
    return (function(__iced_k) {
      ...
      base.sync(__iced_deferrals.defer({
        assign_fn: (function() {
          return function() {
            return syncSuccess = arguments[0];
          };
        })(),
        lineno: 170
      }));
    ...
    return function() {
      ...
      (function(__iced_k) {
        ...
        base.fetchPricing(__iced_deferrals.defer({
          assign_fn: (function() {
            return function() {
              return pricing = arguments[0];
            };
          })(),
          lineno: 174
        }));
        ...
        base.setLocalData(keys.PRICING, pricing);
        $(".go-pro-btn-text").text("GO PRO FOR " + pricing.symbol + pricing.prices.pro);
        return deferredCallback();
      });
    };
  })(this));
...
doEmailVerificationCheck = function() {
  var needsEmailVerification, ___iced_passed_deferral, __iced_deferrals, __iced_k;
  __iced_k = __iced_k_noop;
  ___iced_passed_deferral = iced.findDeferral(arguments);
  (function(_this) {
    return (function(__iced_k) {
    ...
    return function() {
      if (needsEmailVerification) {
        ...
        return $("#verify-email").removeClass("hidden");
      }
    };
  })(this));
};
...
$(document).ready(function() {
  var isLogined, isMakingPayment, isPaymentNeeded, ___iced_passed_deferral, __iced_deferrals, __iced_k;
  __iced_k = __iced_k_noop;
  ___iced_passed_deferral = iced.findDeferral(arguments);
  initView();
  (function(_this) {
    ...
    return function() {
      if (!isLogined) {
        base.redirect(pages.SIGN_IN);
      }
      doEmailVerificationCheck();
      (function(__iced_k) {
        __iced_deferrals = new iced.Deferrals(__iced_k, {
          parent: ___iced_passed_deferral,
          filename: "/Users/nubela/Workspace/gom-chrome/src/pages/js/options.coffee"
        });
        base.getLocalData(keys.IS_MAKING_PAYMENT, false, __iced_deferrals.defer({
          assign_fn: (function() {
            return function() {
              return isMakingPayment = arguments[0];
            };
          })(),
          lineno: 196
        }));
        ...
        (function(__iced_k) {
          if (isMakingPayment) {
            $(".scrim").removeClass("hidden");
            $("#checking-payment").removeClass("hidden");
            (function(__iced_k) {
              __iced_deferrals = new iced.Deferrals(__iced_k, {
                parent: ___iced_passed_deferral,
                filename: "/Users/nubela/Workspace/gom-chrome/src/pages/js/options.coffee"
              ...
              (function(__iced_k) {
                ...
                if (isPaymentNeeded) {
                  $("#checking-payment").addClass("hidden");
                  $("#payment-fail").removeClass("hidden");
                } else {
                  $("#checking-payment").addClass("hidden");
                  $("#payment-success").removeClass("hidden");
                  populatePage();
                }
                base.setLocalData(keys.IS_MAKING_PAYMENT, false);
                return;
                return __iced_k();
              });
            });
          ...
          (function(__iced_k) {
            ...
            return doEmailVerificationCheck();
          });
        });
      });
    };
...
}).call(this,require("pBGvAp"),typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {},require("buffer").Buffer,arguments[3],arguments[4],arguments[5],arguments[6],"/fake_1c005a13.js","/")
},{"./base":5,"./config":6,"./constants":7,"./enum/keys":9,"./enum/pages":10,"buffer":2,"pBGvAp":4}],15:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
var messages;
