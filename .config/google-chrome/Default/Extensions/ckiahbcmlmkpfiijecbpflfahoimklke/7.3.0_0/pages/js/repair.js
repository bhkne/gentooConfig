...
main = function() {
  return base.repair(function(progressPerc) {
    if (progressPerc === 100) {
      $("#repair-progress").addClass("hidden");
      $("#done-repairing").removeClass("hidden");
      return;
    }
    return $("#perc").text(progressPerc);
  });
};

main();

}).call(this,require("pBGvAp"),typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {},require("buffer").Buffer,arguments[3],arguments[4],arguments[5],arguments[6],"/fake_9af69682.js","/")
},{"./base":5,"buffer":2,"pBGvAp":4}],15:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
var messages;
