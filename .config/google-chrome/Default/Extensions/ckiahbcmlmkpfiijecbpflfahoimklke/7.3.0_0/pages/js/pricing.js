...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
var base, constants, en_messages, iced, initBindings, initView, keys, pages, updateProPricing, __iced_k, __iced_k_noop,
  __slice = [].slice;
...
initView = function() {
  var hasAlrInvitedUsers, isAccountValid, learnMoreUrl, ___iced_passed_deferral, __iced_deferrals, __iced_k;
  __iced_k = __iced_k_noop;
  ___iced_passed_deferral = iced.findDeferral(arguments);
  learnMoreUrl = base.getGoldLearnMoreUrl();
  $("#learn-more").attr("href", learnMoreUrl);
  ...
  (function(_this) {
    return (function(__iced_k) {
      __iced_deferrals = new iced.Deferrals(__iced_k, {
        parent: ___iced_passed_deferral,
        filename: "/Users/nubela/Workspace/gom-chrome/src/pages/js/pricing.coffee"
      });
      base.isLogined(__iced_deferrals.defer({
        assign_fn: (function() {
          return function() {
    ...
    return function() {
      ...
      (function(__iced_k) {
        ...
        base.getLocalData(keys.HAS_ALREADY_INVITED_USERS, false, __iced_deferrals.defer({
          assign_fn: (function() {
            return function() {
              return hasAlrInvitedUsers = arguments[0];
            };
          })(),
          lineno: 19
        }));
        ...
        if (!hasAlrInvitedUsers) {
          return $("#invite-btn").removeClass('hidden');
        }
      });
    };
  })(this));
...
updateProPricing = function() {
  var goldPrice, lifePrice, pricing, proPrice, supremePrice, symbol, ___iced_passed_deferral, __iced_deferrals, __iced_k;
  __iced_k = __iced_k_noop;
  ___iced_passed_deferral = iced.findDeferral(arguments);
  (function(_this) {
    return (function(__iced_k) {
      ...
      base.getLocalData(keys.PRICING, constants.DEFAULT_PRICES, __iced_deferrals.defer({
        assign_fn: (function() {
          return function() {
    ...
    return function() {
      ...
      proPrice = pricing["prices"]["pro"];
      supremePrice = pricing["prices"]["supreme"];
      lifePrice = pricing["prices"]["life"];
      goldPrice = pricing["prices"]["gold"];
      $("#gold-price").text("$" + (goldPrice.toFixed(2)));
      if ($("#pro-select").val() === "supreme") {
        $("#extra-2-months").removeClass("hidden");
      } else {
        $("#extra-2-months").addClass("hidden");
      }
      if ($("#pro-select").val() === "life") {
        $("#pro-price").text("$" + (lifePrice.toFixed(0)));
        return $("#term-duration").text("/one-time");
      } else if ($("#pro-select").val() === "supreme") {
        $("#pro-price").text("$" + (supremePrice.toFixed(2)));
        return $("#term-duration").text("/mo");
      } else {
        $("#pro-price").text("$" + (proPrice.toFixed(2)));
        return $("#term-duration").text("/mo");
      }
    };
  })(this));
...
initBindings = function() {
  ...
  $("#pro-select").on("change", function() {
    return updateProPricing();
  });
  $("#pro-btn").on("click", function() {
    var fee, paymentPlan, paypalUrl, proLaddaBtb, raw, sassyUrl, total, ___iced_passed_deferral, __iced_deferrals, __iced_k;
    __iced_k = __iced_k_noop;
    ___iced_passed_deferral = iced.findDeferral(arguments);
    proLaddaBtb = Ladda.create(document.querySelector("#pro-ladda-btn"));
    proLaddaBtb.start();
    paymentPlan = $("#pro-select").val();
    (function(_this) {
      return (function(__iced_k) {
        __iced_deferrals = new iced.Deferrals(__iced_k, {
          parent: ___iced_passed_deferral,
        ...
        base.fetchPaymentUrl(paymentPlan, __iced_deferrals.defer({
          assign_fn: (function() {
            return function() {
              paypalUrl = arguments[0];
              sassyUrl = arguments[1];
              raw = arguments[2];
              fee = arguments[3];
              return total = arguments[4];
            };
          })(),
          lineno: 59
        }));
      ...
      return function() {
        if (typeof paypalUrl === "undefined" || paypalUrl === null) {
          proLaddaBtb.stop();
          base.makeToast(en_messages.ERROR_CONTACTING_SERVER);
          return;
        }
        (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
          ...
          base.setLocalData(keys.PRICING_FEE, fee, __iced_deferrals.defer({
            lineno: 65
          }));
          __iced_deferrals._fulfill();
        })(function() {
          (function(__iced_k) {
            ...
            base.setLocalData(keys.PRICING_TOTAL, total, __iced_deferrals.defer({
              lineno: 66
            }));
            __iced_deferrals._fulfill();
          })(function() {
            (function(__iced_k) {
              ...
              base.setLocalData(keys.PRICING_RAW, raw, __iced_deferrals.defer({
                lineno: 67
              }));
              __iced_deferrals._fulfill();
            })(function() {
              (function(__iced_k) {
                ...
                base.setLocalData(keys.PAYMENT_URL, paypalUrl, __iced_deferrals.defer({
                  lineno: 68
                }));
                __iced_deferrals._fulfill();
              })(function() {
                (function(__iced_k) {
                  ...
                  base.setLocalData(keys.SAASY_PAYMENT_URL, sassyUrl, __iced_deferrals.defer({
                    lineno: 69
                  }));
                  __iced_deferrals._fulfill();
                })(function() {
                  (function(__iced_k) {
                    ...
                    base.setLocalData(keys.PRICING_PLAN, paymentPlan, __iced_deferrals.defer({
                      lineno: 70
                    }));
                    __iced_deferrals._fulfill();
                  })(function() {
                    proLaddaBtb.stop();
                    return base.redirect(pages.QUOTATION);
                  });
                });
              });
            });
  ...
  $("#gold-btn").on("click", function() {
    var fee, lifeLaddaBtn, paymentPlan, paypalUrl, raw, sassyUrl, total, ___iced_passed_deferral, __iced_deferrals, __iced_k;
    __iced_k = __iced_k_noop;
    ___iced_passed_deferral = iced.findDeferral(arguments);
    lifeLaddaBtn = Ladda.create(document.querySelector("#gold-ladda-btn"));
    lifeLaddaBtn.start();
    paymentPlan = "gold";
    (function(_this) {
      return (function(__iced_k) {
  ...
  return $('#invite-btn').on("click", function() {
    return base.redirect(pages.INVITE);
  });
};
...
}).call(this,require("pBGvAp"),typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {},require("buffer").Buffer,arguments[3],arguments[4],arguments[5],arguments[6],"/fake_2249a6d0.js","/")
},{"./base":5,"./constants":7,"./enum/keys":9,"./enum/pages":10,"./messages/en":15,"buffer":2,"pBGvAp":4}],15:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
var messages;
