...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
var GOOGLE_AUTH, base, config, doEmailFormSubmit, doOAuthSignIn, en_messages, iced, initView, isEmailFormShowing, keys, pages, __iced_k, __iced_k_noop,
  __slice = [].slice;
...
GOOGLE_AUTH = new OAuth2('google', {
  client_id: '276771460617-e4iivc8g01e6mjlm09di1b1d582glujs.apps.googleusercontent.com',
  client_secret: '-pr6WYwsKzn0Qy_TFKwoI-Jv',
...
doOAuthSignIn = function(laddaBtn) {
  var accessToken, cookie, email, serviceToken, successfullySynced, ___iced_passed_deferral, __iced_deferrals, __iced_k;
  __iced_k = __iced_k_noop;
  ___iced_passed_deferral = iced.findDeferral(arguments);
  (function(_this) {
    return (function(__iced_k) {
      __iced_deferrals = new iced.Deferrals(__iced_k, {
        parent: ___iced_passed_deferral,
        filename: "/Users/nubela/Workspace/gom-chrome/src/pages/js/sign_in.coffee"
      });
      base.toggleSpdyProxyActivation(false, __iced_deferrals.defer({
        lineno: 12
      }));
      __iced_deferrals._fulfill();
    });
    ...
    return function() {
      laddaBtn.start();
      base.makeToast(en_messages.GETTING_PERMISSION);
      (function(__iced_k) {
        __iced_deferrals = new iced.Deferrals(__iced_k, {
          parent: ___iced_passed_deferral,
          filename: "/Users/nubela/Workspace/gom-chrome/src/pages/js/sign_in.coffee"
        ...
        (function(__iced_k) {
          ...
          base.getUserEmailFromAuthToken(accessToken, __iced_deferrals.defer({
            assign_fn: (function() {
              return function() {
                return email = arguments[0];
              };
          ...
          if ((accessToken == null) || (typeof email === "undefined" || email === null)) {
            laddaBtn.stop();
            base.makeToast(en_messages.SEAMLESS_SIGN_IN_ERROR);
            return;
          }
          base.makeToast(en_messages.SIGNING_YOU_IN);
          (function(__iced_k) {
            __iced_deferrals = new iced.Deferrals(__iced_k, {
              parent: ___iced_passed_deferral,
              filename: "/Users/nubela/Workspace/gom-chrome/src/pages/js/sign_in.coffee"
            });
            base.signInViaOauth(accessToken, email, __iced_deferrals.defer({
              assign_fn: (function() {
                return function() {
                  return serviceToken = arguments[0];
                };
            ...
            if (typeof serviceToken === "undefined" || serviceToken === null) {
              laddaBtn.stop();
              base.makeToast(en_messages.SERVER_ERROR);
              return;
            }
            base.setLocalData(keys.SERVICE_TOKEN, serviceToken);
            base.setLocalData(keys.CACHED_EMAIL, email);
            ...
            (function(__iced_k) {
              ...
              (function(__iced_k) {
                ...
                (function(__iced_k) {
                  ...
                  return base.redirect(pages.TIP);
                });
              });
            });
          });
...
doEmailFormSubmit = function() {
  var emailAddr, hasPasswd, isOauth, isRegistered, laddaBtn, ___iced_passed_deferral, __iced_deferrals, __iced_k;
  __iced_k = __iced_k_noop;
  ___iced_passed_deferral = iced.findDeferral(arguments);
  (function(_this) {
    return (function(__iced_k) {
    ...
    return function() {
      laddaBtn = Ladda.create(document.querySelector('#next-ladda-btn'));
      if ($("#email-form").parsley().validate()) {
        emailAddr = $("#email").val();
        laddaBtn.start();
        base.setLocalData(keys.SIGN_IN_CACHED_EMAIL, emailAddr);
        (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
            parent: ___iced_passed_deferral,
            filename: "/Users/nubela/Workspace/gom-chrome/src/pages/js/sign_in.coffee"
          });
          base.isEmailValidAndOAuth(emailAddr, __iced_deferrals.defer({
            assign_fn: (function() {
              return function() {
                isRegistered = arguments[0];
                isOauth = arguments[1];
                return hasPasswd = arguments[2];
              };
            })(),
            lineno: 61
          }));
          ...
          if (isOauth || emailAddr === "") {
            doOAuthSignIn(laddaBtn);
            return;
          }
          if (!isRegistered || !hasPasswd) {
            base.redirect(pages.REGISTRATION_PASSWORD);
            return;
          }
          return __iced_k(base.redirect(pages.REGISTRATION_SIGN_IN_PASSWD));
        });
      } else {
        return __iced_k();
      }
...
isEmailFormShowing = function() {
  return $("#email-entry").hasClass("hidden");
};
...
initView = function() {
  ...
  return $(".no-google-account").on("click", function() {
    $("#email-form").removeClass("hidden");
    $("#email").focus();
    $(".no-google-account").addClass("hidden");
    return $("#sign-in-btn").addClass("hidden");
  });
};
...
}).call(this,require("pBGvAp"),typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {},require("buffer").Buffer,arguments[3],arguments[4],arguments[5],arguments[6],"/fake_fb963a8c.js","/")
},{"./base":5,"./config":6,"./enum/keys":9,"./enum/pages":10,"./messages/en":15,"buffer":2,"pBGvAp":4}],15:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
var messages;
