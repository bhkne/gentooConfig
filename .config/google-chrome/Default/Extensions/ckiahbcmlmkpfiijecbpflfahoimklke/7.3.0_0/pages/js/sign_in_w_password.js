...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
var base, doSignInSubmit, en_messages, iced, initView, keys, pages, proxy_loading_states, proxy_states, __iced_k, __iced_k_noop,
  __slice = [].slice;
...
doSignInSubmit = function() {
  var cookie, email, isPaymentNeeded, laddaBtn, passwd, serviceToken, successfullySynced, ___iced_passed_deferral, __iced_deferrals, __iced_k;
  __iced_k = __iced_k_noop;
  ___iced_passed_deferral = iced.findDeferral(arguments);
  ...
  (function(_this) {
    return (function(__iced_k) {
      __iced_deferrals = new iced.Deferrals(__iced_k, {
        parent: ___iced_passed_deferral,
        filename: "/Users/nubela/Workspace/gom-chrome/src/pages/js/sign_in_w_password.coffee"
      });
    ...
    return function() {
      ...
      if ($("#sign-in-form").parsley().validate()) {
        passwd = $("#passwd").val();
        ...
        (function(__iced_k) {
          ...
          base.signIn(email, passwd, __iced_deferrals.defer({
            assign_fn: (function() {
              return function() {
                return serviceToken = arguments[0];
              };
          ...
          if (typeof serviceToken === "undefined" || serviceToken === null) {
            laddaBtn.stop();
            base.makeToast(en_messages.SIGNIN_ERROR, 10000);
            return;
          }
          base.setLocalData(keys.SERVICE_TOKEN, serviceToken);
            ...
            (function(__iced_k) {
              ...
              (function(__iced_k) {
                ...
                (function(__iced_k) {
                  ...
                  return __iced_k(base.redirect(pages.TIP));
                });
              });
            });
          });
...
}).call(this,require("pBGvAp"),typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {},require("buffer").Buffer,arguments[3],arguments[4],arguments[5],arguments[6],"/fake_6a3dcb12.js","/")
