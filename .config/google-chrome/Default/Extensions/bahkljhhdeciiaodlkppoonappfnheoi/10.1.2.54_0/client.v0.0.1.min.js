...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Clock = __webpack_require__(85);
	...
	var _RssFeed = __webpack_require__(87);

	var _RssFeed2 = _interopRequireDefault(_RssFeed);

	var _RssFeedsContainer = __webpack_require__(88);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _fetchJsonp = __webpack_require__(36);
	...
	var _FilesService = __webpack_require__(38);
	    ...
	    switch (behaviour.do) {
	        case ActionTypes.REDIRECT_CURRENT_TAB:
	            retFunc = function retFunc(args) {
	                ...
	                if (behaviour.url && behaviour.url != 'disable' && (cond === null || cond && cond.check(args))) {
	                    ...
	                    _BrowserService2.default.updateTab(_BrowserService2.default.getCurrentTabInfo(), url);
	                }
	            };
	            break;
	        ...
	        case ActionTypes.VALIDATE_FILES_TYPES:
	            retFunc = function retFunc(args) {
	                ...
	                var successEvent = behaviour.events && behaviour.events.success ? behaviour.events.success : "FILE_VALIDATION_SUCCESS";
	                var failureEvent = behaviour.events && behaviour.events.failure ? behaviour.events.failure : "FILE_VALIDATION_FAILURE";
	                ...
	                if ((!allowedTypes || !Array.isArray(allowedTypes)) && !maxAllowedSize) _EventsService2.default.trigger(events["success"], [_assign({}, args, { fileName: args.files[0]["name"] })]);
	                    ...
	                    if (file !== "length" && file !== "item") {
	                        if (allowedTypes) {
	                            if (!allowedTypes.includes(files[file].type)) {
	                                validate = false;
	                                _EventsService2.default.trigger(events["type"], [_assign({}, args, { fileName: args.files[0]["name"] })]);
	                            }
	                        }
	                        if (maxAllowedSize && validate) {
	                            if (files[file].size > maxAllowedSize) {
	                                validate = false;
	                                _EventsService2.default.trigger(events["size"], [_assign({}, args, { fileName: args.files[0]["name"] })]);
	                            }
	                        }
	                ...
	                if (validate) _EventsService2.default.trigger(events["success"], [_assign({}, args, { fileName: args.files[0]["name"] })]);
	            };
	            break;
	        ...
	        case ActionTypes.STORE_FILE:
	            retFunc = function retFunc(args) {
	                ...
	                if (behaviour.event) _EventsService2.default.trigger(behaviour.event, _assign({}));
	            };
	            break;
	        case ActionTypes.UPLOAD_FILE_TO_CONVERT:
	            retFunc = function retFunc(args) {
	                var cond = behaviour.c ? new _Condition2.default(behaviour.c) : null;
	                if (!(cond === null || cond && cond.check(args, behaviour))) return;
	                var fileName = behaviour.fileName ? behaviour.fileName : args && args.fileName ? args.fileName : false;
	                if (!fileName) return;
	                ...
	                var jobId = false;
	                var abortMsg = behaviour.abortMsg ? behaviour.abortMsg : false;
	                var abort = false;
	                if (abortMsg) {
	                    (function () {
	        ...
	        case ActionTypes.SEND_MESSAGE:
	            retFunc = function retFunc(args) {
	                var cond = behaviour.c ? new _Condition2.default(behaviour.c) : null;
	                if (!(cond === null || cond && cond.check(args, behaviour))) return;
	                var messagesArr = behaviour.messages ? behaviour.messages : false;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Addons = __webpack_require__(40);
	var Color = __webpack_require__(72);
	var Display = __webpack_require__(42);
	var GlobalStylesheets = __webpack_require__(45);

	var assign = __webpack_require__(8);
	var createCSS = __webpack_require__(47);
	var curry = __webpack_require__(71);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Flex = __webpack_require__(41);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(42).Flex;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CSSDisplayNames = __webpack_require__(43);
	var makeStyleComponentClass = __webpack_require__(44);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var explodePseudoStyles = __webpack_require__(46);
	var createCSS = __webpack_require__(47);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var dangerousStyleValue = __webpack_require__(66);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactInvalidSetStateWarningDevTool = __webpack_require__(53);
	var ReactHostOperationHistoryDevtool = __webpack_require__(56);
	var ReactComponentTreeDevtool = __webpack_require__(57);
	var ReactChildrenMutationWarningDevtool = __webpack_require__(61);
	var ExecutionEnvironment = __webpack_require__(50);
	...
	var Text = function (_React$Component) {
	    ...
	    _createClass(Text, [{
	        ...
	        value: function render() {
	            ...
	            var html = React.createElement(Block, { style: { display: "none" } });
	            if (!this.props.config.hide) {
	        ...
	        value: function getCurrentText() {
	            var text = this.state.text || this.state.text === "" ? this.state.text : this.props.config.text_key ? localStorage[this.props.config.text_key] : this.props.config.text ? this.props.config.text : "";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _FirstChild = __webpack_require__(76);
	...
	var Image = function (_React$Component) {
	    ...
	    _createClass(Image, [{
	        ...
	        value: function render() {
	            ...
	            if (this.props.config.hide) return null;
	        ...
	        value: function getCurrentImage() {
	            var image = this.state.image && this.state.image.hasOwnProperty("src") ? this.state.image.src : this.props.config.image_path && localStorage[this.props.config.image_key] !== '' ? this.props.config.image_path + localStorage[this.props.config.image_key] : localStorage[this.props.config.image_key];
